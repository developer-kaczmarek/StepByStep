...
class TrackDBModelMapper : Mapper<TrackDBModel, TrackEntity> {
    override fun mapToEntity(obj: TrackDBModel): TrackEntity {
        return TrackEntity(obj.id, obj.distance, obj.recordTime, obj.maxSpeed, obj.averageSpeed, obj.currentSpeed, obj.isFinishedRecord)
    }

    override fun mapFromEntity(obj: TrackEntity): TrackDBModel {
        return TrackDBModel(obj.id, obj.distance, obj.recordTime, obj.maxSpeed, obj.averageSpeed, obj.currentSpeed, obj.isFinishedRecord)
    }
}